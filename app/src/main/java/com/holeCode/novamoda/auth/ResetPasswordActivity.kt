...
class ResetPasswordActivity:AppCompatActivity(),TextWatcher, View.OnClickListener {
    ...
    private fun volleyCode(){
        val url = "https://student.valuxapps.com/api/reset-password"
        val email = bindingResetPassword.edEmailforget
        ...
        val request = JsonObjectRequest(
            ...
            jsonObject,
            { response ->
                bindingResetPassword.progressbarforget.visibility
                sendNameEmail()
                onSubmit()
            },
            { error ->
        ...
        val requestQueue = Volley.newRequestQueue(this)  // Replace 'this' with your activity or application context
    ...
    private fun onSubmit(){
        mViewModel.resetPasswordVM(ResetPasswordBody(bindingResetPassword.edEmailforget.text.toString()))
    }
